...
# WeChat needs the opencv-contrib build — plain ``opencv-python`` imports
# fine but lacks ``cv2.wechat_qrcode``, and ``WeChatEngine()`` raises
# ``EngineUnavailable`` at construction. Skip the whole module so a
