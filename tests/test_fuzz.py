...
# Hypothesis is a dev-only dependency (absent in the install-smoke
# cells); skip the whole module at collection time when it's missing —
# same module-level gate pattern as test_apple_vision.py.
pytest.importorskip("hypothesis")

# Import after the skip — without hypothesis the file never reaches here.
