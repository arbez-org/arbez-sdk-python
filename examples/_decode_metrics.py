...
# -- Payload normaliser (follow-up investigation: neutralise zxing-style escaping differences)
#
...
def consensus_validated_recall(
    ...
    * ``disagreement_pct`` -- ``disagreed / (correct + disagreed)``
    ...
    normalise:
        when True (default), apply :func:`normalize_payload`
        ...
        raw payload strings exactly (legacy behaviour, pre-normalisation).
    ...
    # Optional payload normalisation neutralises zxing-style
